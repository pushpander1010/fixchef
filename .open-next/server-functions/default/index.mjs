...
var BuildId = "K64RYsiZCcNjNidxImEBW";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/_global-error/page": "/_global-error", "/api/chat/route": "/api/chat", "/api/generate/route": "/api/generate", "/api/recipes/publish/route": "/api/recipes/publish", "/api/youtube-search/route": "/api/youtube-search", "/robots.txt/route": "/robots.txt", "/icon/route": "/icon", "/sitemap.xml/route": "/sitemap.xml", "/page": "/", "/category/[slug]/page": "/category/[slug]", "/recipes/[slug]/page": "/recipes/[slug]" };
